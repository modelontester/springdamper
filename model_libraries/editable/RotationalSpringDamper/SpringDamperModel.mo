...
model SpringDamperModel
    ...
    .Modelica.Mechanics.Rotational.Components.SpringDamper springDamper(c = 105,d = 1) annotation(Placement(transformation(extent = {{-24.0,8.0},{-4.0,28.0}},origin = {0.0,0.0},rotation = 0.0)));
equation
