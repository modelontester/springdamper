...
model SpringDamperModel
    ...
    .Modelica.Mechanics.Rotational.Components.SpringDamper springDamper(c = 105,d = 1.1) annotation(Placement(transformation(extent = {{-24.0,8.0},{-4.0,28.0}},origin = {0.0,0.0},rotation = 0.0)));
    .Modelica.Mechanics.Rotational.Components.Inertia inertia_3(J = 0.01) annotation(Placement(transformation(extent = {{28,8},{48,28}},origin = {0,0},rotation = 0)));
equation
    ...
    connect(inertia_2.flange_b,inertia_3.flange_a) annotation(Line(points = {{22,18},{28,18}},color = {0,0,0}));
